...
namespace LegalStatistics.ReportRepository.Migrations
{
    ...
    [Migration("20240402135246_CivilRightsStatistics")]
    partial class CivilRightsStatistics
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegalStatistics.ReportRepository.Models.LawImplementation.CivilRights.CivilRights_LawsuitContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CivilRights.LawsuitsContent");
                });

            modelBuilder.Entity("LegalStatistics.ReportRepository.Models.LawImplementation.CivilRights.CivilRights_LegalAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CivilRights.LegalActions");
                });

            modelBuilder.Entity("LegalStatistics.ReportRepository.Models.LawImplementation.CivilRights.CivilRights_Statistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CivilRights.Statistics");
                });

            modelBuilder.Entity("LegalStatistics.ReportRepository.Models.ArbitrationProceeding.ArbitrationProceeding_Statistics", b =>
                {
                    b.HasOne("LegalStatistics.ReportRepository.Models.LawImplementation.CivilRights.CivilRights_LawsuitContent", "LawsuitContent")
                        .WithMany()
                        .HasForeignKey("LawsuitContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LegalStatistics.ReportRepository.Models.LawImplementation.CivilRights.CivilRights_LegalAction", "LegalAction")
                        .WithMany()
